			...
			<div class="col-12 col-lg-4 colDerReservas" style="display:none">
				...
				<div class="row py-4">
					...
					<div class="col-12 col-lg-6 col-xl-7 text-center text-lg-left">
						...
						<h1 class="precioReserva">$<span><?php echo number_format($precioContinental*$dias);?></span> USD</h1>
       			...
       			<?php foreach ($planes as $key => $value): ?>
					...
					<div class="col-12 col-md-6">
						...
						<figure class="center">
	       				...
	       				Temporada Baja: Plan Americano + $ <?php echo number_format($value["precio_baja"]); ?> USD<br>

	       				Temporada Alta: Plan Americano + $ <?php echo number_format($value["precio_alta"]); ?> USD
